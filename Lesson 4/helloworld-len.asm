...
; Compile woth: nasm -f elf helloworld-len.asm
; Link with (64 bit systems require elf_i386 option): ld -m elf_386 hellowrld-len.o -o helloworld-len
...
strlen:					; this is our first function declaration
	...
	mov 	ebx, eax 	; move the address in EAX into EBX (Both pint to the same segment in memory)

nextchar:
	cmp 	bute [eax], 0 ; this is the same as lesson3
	jz 		finished
	inc 	eax
	jmp 	nextchar
